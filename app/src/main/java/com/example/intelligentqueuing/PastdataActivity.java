package com.example.intelligentqueuing;
...
public class PastdataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lineChart = (LineChart)findViewById(R.id.pastline);
        showChart(lineChart);
        getPnumdata();
    }
    //设置图表显示样式
    ...
    private void getPnumdata(){
        netWorkBusiness.getSensorData(deviceID, "number_up", "6", "30", "2019-07-15 00:00:00",
                "2019-07-30 00:00:00", "DESC", "10", "0", new NCallBack<BaseResponseEntity<SensorDataPageDTO>>() {
                    @Override
